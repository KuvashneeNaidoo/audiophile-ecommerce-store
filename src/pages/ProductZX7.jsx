...
const ProductZX7 = ({ cartItems, setCartItems }) => {
  const [quantity, setQuantity] = useState(1);

  const handleAddToCart = () => {
    const existingItem = cartItems.find((item) => item.id === 5);
    if (existingItem) {
      setCartItems(
        cartItems.map((item) =>
          item.id === 5 ? { ...item, quantity: item.quantity + quantity } : item
        )
      );
    } else {
      setCartItems([
      ...
      <section className="py-16">
        <div className="max-w-screen-xl mx-auto xl:px-[165px] px-6 sm:px-12 flex flex-col sm:flex-row items-center justify-center gap-8">
          <div className="w-full lg:w-1/2 flex-1 lg:pr-20 mb-8 lg:mb-0">
            <picture>
              <source media="(max-width: 639px)" srcSet={zx7Data.main.mobile} />
              <source
                media="(max-width: 1023px)"
                srcSet={zx7Data.main.tablet}
              />
              <img
                src={zx7Data.main.desktop}
                alt="ZX7 Speaker"
          ...
          <div className="w-full lg:w-1/2 flex-1 text-center lg:text-left">
            ...
            <p className="mt-4 font-bold text-lg">$ 3,500</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-16">
              <div className="space-y-6 flex flex-col justify-between h-full">
                <div className="flex-1">
                  <picture>
                    <source
                      ...
                      srcSet={zx7Data.gallery[0].mobile}
                    />
                    <source
                      media="(max-width: 1023px)"
                      srcSet={zx7Data.gallery[0].tablet}
                    />
                    <img
                      src={zx7Data.gallery[0].desktop}
                      alt="Image 1"
                ...
                <div className="flex-1">
                  <picture>
                    <source
                      media="(max-width: 767px)"
                      srcSet={zx7Data.gallery[1].mobile}
                    />
                    <source
                      media="(max-width: 1023px)"
                      srcSet={zx7Data.gallery[1].tablet}
                    />
                    <img
                      src={zx7Data.gallery[1].desktop}
                      alt="Image 2"
                      className="w-full h-full object-cover rounded-lg shadow-lg"
                    />
                  </picture>
              ...
              <div className="md:col-span-2">
                <picture>
                  <source
                    media="(max-width: 767px)"
                    srcSet={zx7Data.gallery[2].mobile}
                  />
                  <source
                    media="(max-width: 1023px)"
                    srcSet={zx7Data.gallery[2].tablet}
                  />
                  <img
                    src={zx7Data.gallery[2].desktop}
                    alt="Large Image"
